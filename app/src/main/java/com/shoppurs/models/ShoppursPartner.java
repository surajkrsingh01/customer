...
public class ShoppursPartner implements Serializable {
    ...
    private String name, email, mobile,password, affilateCode, address, country, state, city, zip, latitude, longitude,
            userType, bankName, accountHolderName, bankAccountNumber, ifscCode, branchAddress, chequeImage,
            panNumber, adharNumber, panPic, adharPic, imeiNumber, kycStatus, jwtToken, fcmToken, otp, profilePic, isActive,
            status, createdBy, updatedBy, createdDate, updatedDate, vehicleId, vehicleType, vehicleRegNumber,rcPic;
    ...
    public String getAdharPic() {
        return adharPic;
    }

    public void setAdharPic(String adharPic) {
        this.adharPic = adharPic;
    }
