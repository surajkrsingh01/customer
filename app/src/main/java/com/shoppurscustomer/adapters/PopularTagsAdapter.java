...
public class PopularTagsAdapter extends RecyclerView.Adapter<PopularTagsAdapter.MyViewHolder> {
    private Context context;
    private List<Category> categoryList;
    private int selectedIndex;

    public PopularTagsAdapter(Context context, List<Category> categoryList) {
        this.context = context;
        this.categoryList = categoryList;
    }

    @Override
    public PopularTagsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.layout_categories, parent, false);
        return new PopularTagsAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final PopularTagsAdapter.MyViewHolder myViewHolder, final int position) {
        {
